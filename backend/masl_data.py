...
def _game(gid, date, home, away, hs, as_, quarters, stats, timeline, rayo, casey, featured=False):
    return {
        "id": gid, "date": date, "status": "Final",
...
GAMES = [
    _game(
        "mil-uti-17-2", "2026-02-14", "milwaukee", "utica", 17, 2,
        ...
        timeline=[
            ...
            {"q": 4, "time": "02:10", "team": "milwaukee", "player": "Max Touloute", "note": "Empty-net, keeper pulled"},
        ],
        rayo="Diecisiete! SEVENTEEN! I've never seen a board game turn into a track meet like this — the Wave were flying and Utica couldn't get a line change to stick. That's arena soccer, baby.",
        casey="The tape says otherwise on effort — Utica just got buried by transition. Milwaukee turned 34 shots on goal into 17, and a 4-for-5 power play is the real story. That's not luck — that's a pattern.",
        featured=True,
    ),
    _game(
        "sd-emp-marques", "2026-03-08", "san-diego", "empire", 9, 6,
        quarters=[[2, 2], [3, 1], [2, 2], [2, 1]],
        stats={
            "home": {"goals": 9, "shots": 41, "sog": 26, "possession": 57, "power_play": "3/4", "saves": 15},
            "away": {"goals": 6, "shots": 33, "sog": 19, "possession": 43, "power_play": "2/5", "saves": 17},
        },
        timeline=[
        ...
        casey="Let's slow it down for a second: three goals tonight pushes him to 52 on the year. San Diego's 3-for-4 on the power play is why they controlled it — Empire couldn't survive the man-down.",
    ),
    _game(
        "bal-stl-blast", "2026-03-01", "baltimore", "st-louis", 8, 5,
        quarters=[[2, 1], [2, 2], [2, 1], [2, 1]],
        stats={
            "home": {"goals": 8, "shots": 38, "sog": 22, "possession": 61, "power_play": "2/3", "saves": 17},
            "away": {"goals": 5, "shots": 29, "sog": 16, "possession": 39, "power_play": "1/4", "saves": 14},
        },
        timeline=[
            {"q": 1, "time": "10:15", "team": "baltimore", "player": "Juan Pereira", "note": "Service into the box"},
            {"q": 2, "time": "07:30", "team": "st-louis", "player": "Zach Reget", "note": "Off the boards"},
            {"q": 4, "time": "03:44", "team": "baltimore", "player": "Vini Dantas", "note": "Power play dagger"},
        ],
        rayo="Baltimore just SUFFOCATED them — 61% possession, playing keep-away off the boards like it's a clinic. Pereira is money in tight, mi gente.",
        casey="That's the Blast blueprint. They win the possession battle, limit your shots on goal, and pick you apart on the man-up. Repeatable. That's not luck — that's a pattern.",
    ),
    _game(
        "tac-kc-west", "2026-02-28", "tacoma", "kansas-city", 7, 6,
        quarters=[[1, 2], [2, 1], [2, 2], [2, 1]],
        stats={
            "home": {"goals": 7, "shots": 35, "sog": 20, "possession": 52, "power_play": "1/2", "saves": 14},
            "away": {"goals": 6, "shots": 34, "sog": 18, "possession": 48, "power_play": "2/3", "saves": 13},
        },
        timeline=[
            {"q": 4, "time": "00:38", "team": "tacoma", "player": "Nick Perera", "note": "Game-winner, top corner"},
            {"q": 3, "time": "04:11", "team": "kansas-city", "player": "Guy Abend", "note": "Man-up equalizer"},
        ],
        rayo="Perera with THIRTY-EIGHT seconds left — don't blink! A one-goal barnburner for a playoff spot out west, this is why I love this sport.",
        casey="Coin-flip game statistically — 52-48 possession, near-even shots on goal. It came down to one power-play stop. Tacoma's penalty kill won it.",
    ),
    _game(
        "uti-tac-skid", "2026-03-15", "utica", "tacoma", 4, 9,
        quarters=[[1, 2], [1, 3], [1, 2], [1, 2]],
        stats={
            "home": {"goals": 4, "shots": 26, "sog": 14, "possession": 41, "power_play": "1/3", "saves": 18},
            "away": {"goals": 9, "shots": 44, "sog": 27, "possession": 59, "power_play": "3/4", "saves": 10},
        },
        timeline=[
            {"q": 2, "time": "05:50", "team": "tacoma", "player": "Mohammed Alattas", "note": "Counter, don't blink"},
            {"q": 3, "time": "08:20", "team": "utica", "player": "Slobodan Cvetkovic", "note": "Off the wall"},
        ],
        rayo="Man, my heart goes out to Utica — that's eleven straight now. Cvetkovic keeps swinging but the boards can't save you when the shots keep coming.",
        casey="Eleven-game skid, and the numbers tell you why: they're getting out-shot 44 to 26 and giving up a 75% power play. The margin isn't effort — it's transition defense.",
    ),
]
